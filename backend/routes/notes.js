...
router.put('/updatenote/:id', fetchuser, async (req, res) => {
    ...
    try {
        ...
        // console.log(notes.id.toString());
        
        if (!notes) { return res.status(404).send("Not Found") }
        console.log(notes.user.toString() + "," + req.user.id);

        //id of the user in the note(foreign key) !== user editing it currently ....fetching from Notes.js
